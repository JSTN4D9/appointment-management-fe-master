...
import { useFetchUserByIdQuery } from "../../services/api/usersApi"; // Using User API to fetch both user and staff data
...
const ReviewsBase = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 200,
      renderCell: (params) => {
        const { data: staff } = useFetchUserByIdQuery(params.row.staffId);
